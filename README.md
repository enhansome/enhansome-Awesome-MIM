...
* **BEiT: BERT Pre-Training of Image Transformers**<br>
  *Hangbo Bao, Li Dong, Furu Wei*<br>
  ...
  \[[Code](https://github.com/microsoft/unilm/tree/master/beit) ⭐ 22,214 | 🐛 686 | 🌐 Python | 📅 2026-08-26]
   <details close>
...
* **Improving Pixel-based MIM by Reducing Wasted Modeling Capability**<br>
  *Yuan Liu, Songyang Zhang, Jiacheng Chen, Zhaohui Yu, Kai Chen, Dahua Lin*<br>
  ...
  \[[Code](https://github.com/open-mmlab/mmpretrain/tree/dev) ⭐ 3,853 | 🐛 273 | 🌐 Python | 📅 2024-11-01]
   <details close>
...
* **DiT: Self-supervised Pre-training for Document Image Transformer**<br>
  *Junlong Li, Yiheng Xu, Tengchao Lv, Lei Cui, Cha Zhang, Furu Wei*<br>
  ACMMM'2022 \[[Paper](https://arxiv.org/abs/2203.02378)] [Code](https://github.com/microsoft/unilm/tree/master/dit) ⭐ 22,214 | 🐛 686 | 🌐 Python | 📅 2026-08-26]
  \[[Code](https://github.com/scok30/mae-cil) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2024-06-04]
   <details close>
...
* **PonderV2: Pave the Way for 3D Foundataion Model with A Universal Pre-training Paradigm**<br>
  *Haoyi Zhu, Honghui Yang, Xiaoyang Wu, Di Huang, Sha Zhang, Xianglong He, Tong He, Hengshuang Zhao, Chunhua Shen, Yu Qiao, Wanli Ouyang*<br>
  ...
  \[[Code](https://github.com/Pointcept/Pointcept) ⭐ 3,218 | 🐛 366 | 🌐 Python | 📅 2026-09-11]
...
* [unilm](https://github.com/microsoft/unilm) ⭐ 22,214 | 🐛 686 | 🌐 Python | 📅 2026-08-26: Large-scale Self-supervised Pre-training Across Tasks, Languages, and Modalities.
* [MMPretrain](https://github.com/open-mmlab/mmpretrain) ⭐ 3,853 | 🐛 273 | 🌐 Python | 📅 2024-11-01: OpenMMLab self-supervised pre-training toolbox and benchmark.
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,807 | 🐛 106 | 🌐 Python | 📅 2026-09-11: A python library for self-supervised learning on images.
