...
* **BEiT: BERT Pre-Training of Image Transformers**<br>
  *Hangbo Bao, Li Dong, Furu Wei*<br>
  ...
  \[[Code](https://github.com/microsoft/unilm/tree/master/beit) ⭐ 22,228 | 🐛 687 | 🌐 Python | 📅 2026-09-21]
   <details close>
...
* **An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale**<br>
  *Alexey Dosovitskiy, Lucas Beyer, Alexander Kolesnikov, Dirk Weissenborn, Xiaohua Zhai, Thomas Unterthiner, Mostafa Dehghani, Matthias Minderer, Georg Heigold, Sylvain Gelly, Jakob Uszkoreit, Neil Houlsby*<br>
  ...
  \[[Code](https://github.com/google-research/vision_transformer) ⭐ 12,722 | 🐛 141 | 🌐 Jupyter Notebook | 📅 2026-08-01]
   <details close>
...
* **DiT: Self-supervised Pre-training for Document Image Transformer**<br>
  *Junlong Li, Yiheng Xu, Tengchao Lv, Lei Cui, Cha Zhang, Furu Wei*<br>
  ACMMM'2022 \[[Paper](https://arxiv.org/abs/2203.02378)] [Code](https://github.com/microsoft/unilm/tree/master/dit) ⭐ 22,228 | 🐛 687 | 🌐 Python | 📅 2026-09-21]
  \[[Code](https://github.com/scok30/mae-cil) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2024-06-04]
   <details close>
...
* **PonderV2: Pave the Way for 3D Foundataion Model with A Universal Pre-training Paradigm**<br>
  *Haoyi Zhu, Honghui Yang, Xiaoyang Wu, Di Huang, Sha Zhang, Xianglong He, Tong He, Hengshuang Zhao, Chunhua Shen, Yu Qiao, Wanli Ouyang*<br>
  ...
  \[[Code](https://github.com/Pointcept/Pointcept) ⭐ 3,233 | 🐛 367 | 🌐 Python | 📅 2026-09-11]
...
* **GeoMAE: Masked Geometric Target Prediction for Self-supervised Point Cloud Pre-Training**<br>
  *Xiaoyu Tian, Haoxi Ran, Yue Wang, Hang Zhao*<br>
  CVPR'2023 \[[Paper](https://arxiv.org/abs/2305.08808)] \[[Code](https://github.com/ZrrSkywalker/I2P-MAE) ⭐ 229 | 🐛 7 | 🌐 Python | 📅 2023-08-10]
...
* **NeRF-MAE : Masked AutoEncoders for Self Supervised 3D representation Learning for Neural Radiance Fields**<br>
  *Muhammad Zubair Irshad, Sergey Zakahrov, Vitor Guizilini, Adrien Gaidon, Zsolt Kira, Rares Ambrus*<br>
  ...
  \[[Code](https://github.com/zubair-irshad/NeRF-MAE) ⭐ 107 | 🐛 0 | 🌐 Python | 📅 2025-03-20]
...
* **Masked Spatio-Temporal Structure Prediction for Self-supervised Learning on Point Cloud Videos**<br>
  *Zhiqiang Shen, Xiaoxiao Sheng, Hehe Fan, Longguang Wang, Yulan Guo, Qiong Liu, Hao Wen, Xi Zhou*<br>
  ICCV'2023 \[[Paper](https://arxiv.org/abs/2308.09245)] \[[Code](https://github.com/JohnsonSign/MaST-Pre) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2024-10-04]
   <details close>
...
* [unilm](https://github.com/microsoft/unilm) ⭐ 22,228 | 🐛 687 | 🌐 Python | 📅 2026-09-21: Large-scale Self-supervised Pre-training Across Tasks, Languages, and Modalities.
...
* [lightly](https://github.com/lightly-ai/lightly) ⭐ 3,814 | 🐛 107 | 🌐 Python | 📅 2026-09-21: A python library for self-supervised learning on images.
...
* [solo-learn](https://github.com/vturrisi/solo-learn) ⭐ 1,578 | 🐛 18 | 🌐 Python | 📅 2026-07-27: A library of self-supervised methods for visual representation learning powered by Pytorch Lightning.
